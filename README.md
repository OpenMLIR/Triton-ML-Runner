...
[TLX](https://github.com/facebookexperimental/triton) support is available for the [fbtriton v3.7.4](https://pypi.org/project/fbtriton/3.7.4/) release (`pip install fbtriton==3.7.4`) in [examples/runner/tlx/README.md](./examples/runner/tlx/README.md).
...
Provide the `.ttir` file and point the runner at its directory, typically with `ttir_dir=triton_runner.get_file_dir(__file__)`. See [examples/runner/v3.8.0/ttir/matmul/matmul.py](./examples/runner/v3.8.0/ttir/matmul/matmul.py).
...
- Triton `v3.8.0`: [examples/runner/v3.8.0](./examples/runner/v3.8.0)
- Triton `v3.7.0`: [examples/runner/v3.7.0](./examples/runner/v3.7.0)
- Triton `v3.6.0`: [examples/runner/v3.6.0](./examples/runner/v3.6.0)
- Triton `v3.0.0` ~ `v3.5.x`: [`v3.5.x`](./examples/runner/v3.5.x), [`v3.4.0`](./examples/runner/v3.4.0), [`v3.3.x`](./examples/runner/v3.3.x), [`v3.2.0`](./examples/runner/v3.2.0), [`v3.1.0`](./examples/runner/v3.1.0), [`v3.0.0`](./examples/runner/v3.0.0)
