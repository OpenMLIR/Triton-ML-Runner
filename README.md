...
Provide the `.ttir` file and point the runner at its directory, typically with `ttir_dir=triton_runner.get_file_dir(__file__)`. See [examples/runner/v3.7.0/ttir/matmul/matmul.py](./examples/runner/v3.7.0/ttir/matmul/matmul.py).
...
TTGIR is architecture-aware. Provide the matching `.ttgir` file and, when needed, the corresponding metadata JSON. See [examples/runner/v3.7.0/ttgir/sm90/matmul-with-tma-v4.py](./examples/runner/v3.7.0/ttgir/sm90/matmul-with-tma-v4.py).
...
- LLIR example: [examples/runner/v3.7.0/llir/sm90/matmul-with-tma-v4.py](./examples/runner/v3.7.0/llir/sm90/matmul-with-tma-v4.py)
- PTX example: [examples/runner/v3.7.0/ptx/sm90/matmul-with-tma-v4.py](./examples/runner/v3.7.0/ptx/sm90/matmul-with-tma-v4.py)
- cubin example: [examples/runner/v3.7.0/cubin/sm90/matmul-with-tma-v4.py](./examples/runner/v3.7.0/cubin/sm90/matmul-with-tma-v4.py)
- Example metadata: [examples/runner/v3.7.0/llir/sm90/matmul_kernel_make_tensor_desciptor.json](./examples/runner/v3.7.0/llir/sm90/matmul_kernel_make_tensor_desciptor.json)
...
- Triton `v3.7.0`: [examples/runner/v3.7.0](./examples/runner/v3.7.0)
